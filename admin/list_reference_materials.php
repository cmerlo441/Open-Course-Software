...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function toggle_availability(id) {
            ...
            if ($('div#available > span.available').html() ==
            'Available for download') {
                $('div#available > span.available').html('Unavailable for download');
                $('tr[id=' + id + '] td.available span').html('No.');
            }
            else {
                $('div#available > span.available').html('Available for download');
                $('tr[id=' + id + '] td.available span').html('Yes.');
            }
        }
        ...
        $('a.avail').click(function() {
            ...
            if ($('tr[id=' + id + '] td.available span').html() == 'Yes.') 
                $('tr[id=' + id + '] td.available span').html('No.');
            else 
                $('tr[id=' + id + '] td.available span').html('Yes.');
        })
