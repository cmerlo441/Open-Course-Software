...
"INSERT INTO `syllabus_sections` VALUES "
    ...
    . "(11,'Disabilities','If you have a physical, psychological, medical, or learning disability that may affect your ability to carry out the assigned coursework, you should contact the staff at the Center for Students with Disabilities, Building U, 572-7241. TTY 572-7617. CSD counselors will review your concerns and determine to what reasonable accommodations you are entitled as covered by the Americans with Disabilities Act and section 504 of the Rehabilitation Act of 1973.  All information and documentation pertaining to personal disabilities will be kept confidential.

Because CSD keeps all information confidential, I have no way of knowing whether you qualify for any accommodations unless you notify me.  If you need testing accommodations, please notify me one week before the test so that the proper accommodations can be set up.',1,8),"
    ...
    . "(28,'Twitter','',0,10),"
    . "(29,'Math Center','Students should avail themselves of the resources and educational assistance available in the Math Center in B 130.',1,29),"
    . "(30,'Math Success Center','The Math Success Center is located in Building B, Room 116. The MSC exists solely to help students like you succeed in a non-credit math course. Walk-in help for brief answers is available any time the center is open. They also offer individual and group tutoring sessions, help with homework, and help with math anxiety issues. You have already paid for these services as part of your fees, so make sure to take advantage of them as soon as you feel you need to.',1,30)";
